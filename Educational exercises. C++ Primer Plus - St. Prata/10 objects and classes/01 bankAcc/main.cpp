...
// main.cpp Здесь приведена программа-демонстратор работы класса
#include <iostream>
#include "bankAcc.h"
...
int main()
{
    ...
    cout << "incorrect .withdraw & .toUp demonstrations\n\n"; // некорректное снятие и пополнение счёта
    accounts[2].withdraw(4000);                               // попытка снять больше, чем имееется на счету
    accounts[2].withdraw(-4000);                              // попытка пополнить отрицательным числом
    accounts[2].show();
