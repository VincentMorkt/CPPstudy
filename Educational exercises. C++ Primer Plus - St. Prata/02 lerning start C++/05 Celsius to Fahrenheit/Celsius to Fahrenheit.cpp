...
// принимающую в качестве аргумента значение температуры по Цельсию и возвращающую эквивалентное
// значение температуры по Фаренгейту.
...
int main()
{
    ...
    cin.get();
    cout << degrees << " degrees Celsius is " << CelsiusToFahrenheit(degrees) << " degrees Fahrenheit." << endl;
    // объект cout выводит в консоль возврат вызова функции с передачей ей значения переменной
    cin.get();
    return 0;
}
